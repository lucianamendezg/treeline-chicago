...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@jyenterbriars/treelinetest";
  public static final String SHELL_APP_SCHEME = "exp58fafc7de3184858823ead729129ac92";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@jyenterbriars/treelinetest", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40jyenterbriars%2Ftreelinetest%2F1.0.0%2Fe73422f9a71cfcee3d1461d7341153d9-35.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
